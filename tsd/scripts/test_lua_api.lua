...
test("sceneAnimation:numberOfAnimations()", function()
  sceneAnimation:removeAllAnimations()
  local count = sceneAnimation:numberOfAnimations()
  assert(count == 0, "fresh sceneAnimation should have 0 animations")
end)

test("sceneAnimation:addAnimation(name)", function()
  sceneAnimation:removeAllAnimations()
  local anim = sceneAnimation:addAnimation("testAnim")
  assert(anim ~= nil, "animation should be created")
  assert(sceneAnimation:numberOfAnimations() == 1, "should have 1 animation")
end)

test("animation name", function()
  sceneAnimation:removeAllAnimations()
  local anim = sceneAnimation:addAnimation("myAnimation")
...
test("sceneAnimation:setAnimationTime / getAnimationTime", function()
  sceneAnimation:setAnimationTime(0.5)
  local t = sceneAnimation:getAnimationTime()
  assert(math.abs(t - 0.5) < 0.001, "animation time should be 0.5")
end)

test("sceneAnimation:setAnimationIncrement / getAnimationIncrement", function()
  sceneAnimation:setAnimationIncrement(0.02)
  local inc = sceneAnimation:getAnimationIncrement()
  assert(math.abs(inc - 0.02) < 0.001, "animation increment should be 0.02")
end)

test("sceneAnimation:incrementAnimationTime", function()
  sceneAnimation:setAnimationTime(0.0)
  sceneAnimation:setAnimationIncrement(0.1)
  sceneAnimation:incrementAnimationTime()
  local t = sceneAnimation:getAnimationTime()
...
test("sceneAnimation:addAnimation creates animation with bindings", function()
  sceneAnimation:removeAllAnimations()
  local anim = sceneAnimation:addAnimation("bindingAnim")
  assert(anim ~= nil, "animation should be created")
  assert(anim.name == "bindingAnim", "animation name should match")
end)

test("sceneAnimation:removeAnimation(index)", function()
  sceneAnimation:removeAllAnimations()
  sceneAnimation:addAnimation("toRemove")
  assert(sceneAnimation:numberOfAnimations() == 1, "should have 1 animation")
  sceneAnimation:removeAnimation(0)
  assert(sceneAnimation:numberOfAnimations() == 0,
      "should have 0 animations after removal")
end)

test("sceneAnimation:removeAllAnimations()", function()
  sceneAnimation:removeAllAnimations()
  sceneAnimation:addAnimation("anim1")
  sceneAnimation:addAnimation("anim2")
  assert(sceneAnimation:numberOfAnimations() == 2, "should have 2 animations")
  sceneAnimation:removeAllAnimations()
  assert(sceneAnimation:numberOfAnimations() == 0,
      "should have 0 animations after removeAll")
end)
