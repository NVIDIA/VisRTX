...
test("animationMgr:numberOfAnimations()", function()
  animationMgr:removeAllAnimations()
  local count = animationMgr:numberOfAnimations()
  assert(count == 0, "fresh animationMgr should have 0 animations")
end)

test("animationMgr:addAnimation(name)", function()
  animationMgr:removeAllAnimations()
  local anim = animationMgr:addAnimation("testAnim")
  assert(anim ~= nil, "animation should be created")
  assert(animationMgr:numberOfAnimations() == 1, "should have 1 animation")
end)

test("animation name", function()
  animationMgr:removeAllAnimations()
  local anim = animationMgr:addAnimation("myAnimation")
...
test("animationMgr:setAnimationTime / getAnimationTime", function()
  animationMgr:setAnimationTime(0.5)
  local t = animationMgr:getAnimationTime()
  assert(math.abs(t - 0.5) < 0.001, "animation time should be 0.5")
end)

test("animationMgr:setAnimationIncrement / getAnimationIncrement", function()
  animationMgr:setAnimationIncrement(0.02)
  local inc = animationMgr:getAnimationIncrement()
  assert(math.abs(inc - 0.02) < 0.001, "animation increment should be 0.02")
end)

test("animationMgr:incrementAnimationTime", function()
...
test("animationMgr:addAnimation creates animation with bindings", function()
  animationMgr:removeAllAnimations()
  local anim = animationMgr:addAnimation("bindingAnim")
  assert(anim ~= nil, "animation should be created")
  assert(anim.name == "bindingAnim", "animation name should match")
end)

test("animationMgr:removeAnimation(index)", function()
  animationMgr:removeAllAnimations()
  animationMgr:addAnimation("toRemove")
  assert(animationMgr:numberOfAnimations() == 1, "should have 1 animation")
  animationMgr:removeAnimation(0)
  assert(animationMgr:numberOfAnimations() == 0,
      "should have 0 animations after removal")
end)

test("animationMgr:removeAllAnimations()", function()
  animationMgr:removeAllAnimations()
  animationMgr:addAnimation("anim1")
  animationMgr:addAnimation("anim2")
  assert(animationMgr:numberOfAnimations() == 2, "should have 2 animations")
  animationMgr:removeAllAnimations()
  assert(animationMgr:numberOfAnimations() == 0,
